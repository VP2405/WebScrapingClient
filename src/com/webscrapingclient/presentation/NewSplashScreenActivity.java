...
/**
 * Schermata iniziale che attende il recupero dei dati sui profili mediante
 * chiamata alla corrispettiva API REST
 * 
 * @author Vanessa
 * 
 */
public class NewSplashScreenActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// aspetta 3 secondi e verifica che sia disponibile la connessione a
		// Internet
		...
		new Thread(new Runnable() {
			public void run() {
				...
				try {
					...
					profilesList = callRestService
							.callRestServiceForListProfiles();
				...
				// passa all'activity successiva solo se si è ottenuta risposta
				// da parte del server
				if (profilesList != null) {
					Intent i = new Intent(NewSplashScreenActivity.this,
	...
	private void createWarningDialog(String msg) {
		...
		title_dialog.setCompoundDrawablesWithIntrinsicBounds(
