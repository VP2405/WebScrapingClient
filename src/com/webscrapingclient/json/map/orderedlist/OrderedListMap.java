...
public class OrderedListMap implements Parcelable {
	...
	public void setOrdered_hotels_ids_list(ArrayList<Integer> ordered_hotels_ids_list)
	{
	...
	public void setOrdered_restaurants_ids_list(ArrayList<Integer> ordered_restaurants_ids_list)
	{
    ...
    protected OrderedListMap(Parcel in) {
        ...
        if (in.readByte() == 0x01) {
            ...
            in.readList(ordered_restaurants_ids_list, Integer.class.getClassLoader());
        } else {
